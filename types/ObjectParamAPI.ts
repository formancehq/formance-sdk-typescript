...
export class ObjectWebhooksApi {
     ...
     * @param param the request object
     */
    public activateOneConfig(param: WebhooksApiActivateOneConfigRequest, options?: Configuration): Promise<ConfigActivatedResponse> {
     ...
     * @param param the request object
     */
    public changeOneConfigSecret(param: WebhooksApiChangeOneConfigSecretRequest, options?: Configuration): Promise<ConfigActivatedResponse> {
     ...
     * @param param the request object
     */
    public deactivateOneConfig(param: WebhooksApiDeactivateOneConfigRequest, options?: Configuration): Promise<ConfigDeactivatedResponse> {
     ...
     * @param param the request object
     */
    public insertOneConfig(param: WebhooksApiInsertOneConfigRequest, options?: Configuration): Promise<ConfigActivatedResponse> {
