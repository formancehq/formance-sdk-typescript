...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("authV1CreateClient failed:", res.error);
  }
}
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [auth.ClientOptions2](../../sdk/models/auth/clientoptions2.md)                                                                                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("authV1CreateSecret failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("authV1DeleteClient failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("authV1DeleteSecret failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("authV1GetOIDCWellKnowns failed:", res.error);
  }
}
...
<!-- UsageSnippet language="typescript" operationID="getServerInfo_auth" method="get" path="/api/auth/_info" -->
```typescript
import { SDK } from "@formance/formance-sdk";
...
async function run() {
  const result = await sdk.auth.v1.getServerInfoAuth();
...
```typescript
import { SDKCore } from "@formance/formance-sdk/core.js";
import { authV1GetServerInfoAuth } from "@formance/formance-sdk/funcs/authV1GetServerInfoAuth.js";
...
async function run() {
  const res = await authV1GetServerInfoAuth(sdk);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("authV1GetServerInfoAuth failed:", res.error);
  }
}
...
**Promise\<[operations.GetServerInfoAuthResponse](../../sdk/models/operations/getserverinfoauthresponse.md)\>**
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("authV1ListClients failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("authV1ListUsers failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("authV1ReadClient failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("authV1ReadUser failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("authV1UpdateClient failed:", res.error);
  }
}
