...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("walletsV1ConfirmHold failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("walletsV1CreateBalance failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("walletsV1CreateWallet failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("walletsV1CreditWallet failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("walletsV1DebitWallet failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("walletsV1GetBalance failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("walletsV1GetHold failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("walletsV1GetHolds failed:", res.error);
  }
}
...
<!-- UsageSnippet language="typescript" operationID="getServerInfo_wallets" method="get" path="/api/wallets/_info" -->
```typescript
import { SDK } from "@formance/formance-sdk";
...
async function run() {
  const result = await sdk.wallets.v1.getServerInfoWallets();
...
```typescript
import { SDKCore } from "@formance/formance-sdk/core.js";
import { walletsV1GetServerInfoWallets } from "@formance/formance-sdk/funcs/walletsV1GetServerInfoWallets.js";
...
async function run() {
  const res = await walletsV1GetServerInfoWallets(sdk);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("walletsV1GetServerInfoWallets failed:", res.error);
  }
}
...
**Promise\<[operations.GetServerInfoWalletsResponse](../../sdk/models/operations/getserverinfowalletsresponse.md)\>**
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("walletsV1GetTransactions failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("walletsV1GetWallet failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("walletsV1GetWalletSummary failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("walletsV1ListBalances failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("walletsV1ListWallets failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("walletsV1UpdateWallet failed:", res.error);
  }
}
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("walletsV1VoidHold failed:", res.error);
  }
}
