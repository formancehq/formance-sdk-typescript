...
```typescript
import { WebhooksConfig } from "@formance/formance-sdk/sdk/models/webhooks";

let value: WebhooksConfig = {
  active: true,
  createdAt: new Date("2024-11-11T09:04:54.417Z"),
  ...
  updatedAt: new Date("2026-03-22T18:00:09.972Z"),
};
```
