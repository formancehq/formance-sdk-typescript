...
```typescript
import { V3PaymentServiceUserDeleteConnectionResponseData } from "@formance/formance-sdk/sdk/models/payments";

let value: V3PaymentServiceUserDeleteConnectionResponseData = {
  taskID: "<id>",
};
```
