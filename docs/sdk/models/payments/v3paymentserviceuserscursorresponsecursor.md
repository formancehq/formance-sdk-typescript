...
```typescript
import { V3PaymentServiceUsersCursorResponseCursor } from "@formance/formance-sdk/sdk/models/payments";
...
| --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| `data`                                                                                  | [payments.V3PaymentServiceUser](../../../sdk/models/payments/v3paymentserviceuser.md)[] | :heavy_check_mark:                                                                      | N/A                                                                                     |                                                                                         |
