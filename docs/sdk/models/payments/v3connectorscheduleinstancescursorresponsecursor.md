...
```typescript
import { V3ConnectorScheduleInstancesCursorResponseCursor } from "@formance/formance-sdk/sdk/models/payments";
...
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `data`                                                              | [payments.V3Instance](../../../sdk/models/payments/v3instance.md)[] | :heavy_check_mark:                                                  | N/A                                                                 |                                                                     |
