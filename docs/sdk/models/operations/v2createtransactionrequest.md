...
| `v2PostTransaction`                                                                                                                                                                    | [ledger.V2PostTransaction](../../../sdk/models/ledger/v2posttransaction.md)                                                                                                            | :heavy_check_mark:                                                                                                                                                                     | The request body must contain at least one of the following objects:<br/>  - `postings`: suitable for simple transactions<br/>  - `script`: enabling more complex transactions with Numscript<br/> |                                                                                                                                                                                        |
...
| `force`                                                                                                                                                                                | *boolean*                                                                                                                                                                              | :heavy_minus_sign:                                                                                                                                                                     | Disable balance checks when passing postings                                                                                                                                           | true                                                                                                                                                                                   |
