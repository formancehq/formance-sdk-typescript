...
| --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| `createTransaction`                                                                                       | [shared.RevertTransactionResponse](../../../sdk/models/shared/reverttransactionresponse.md)               | :heavy_minus_sign:                                                                                        | N/A                                                                                                       |
...
| `revertTransaction`                                                                                       | [shared.RevertTransactionResponse](../../../sdk/models/shared/reverttransactionresponse.md)               | :heavy_minus_sign:                                                                                        | N/A                                                                                                       |