...
const value: shared.TaskWise = {
  connectorID: "<id>",
  createdAt: new Date("2024-01-02T14:55:44.073Z"),
  descriptor: {},
  id: "fb608d09-fa9e-4cc0-a730-91f7bd0fa498",
  status: TaskStatus.Failed,
  updatedAt: new Date("2025-12-20T10:23:41.730Z"),
};
```
...
const value: shared.TaskBankingCircle = {
  connectorID: "<id>",
  createdAt: new Date("2025-11-30T07:32:33.754Z"),
  descriptor: {},
  id: "e0044afb-5429-41dd-bd12-bf631eb1934c",
  status: TaskStatus.Failed,
  updatedAt: new Date("2025-10-22T22:58:55.068Z"),
};
```
...
const value: shared.TaskMoneycorp = {
  connectorID: "<id>",
  createdAt: new Date("2026-05-01T08:08:58.599Z"),
  descriptor: {},
  id: "596ed08d-486e-44cb-b9e6-21faee8410a5",
  status: TaskStatus.Active,
  updatedAt: new Date("2025-09-24T21:46:16.635Z"),
};
```
