...
import { V2DeleteLedgerMetadataServerList } from "../sdk/models/operations/v2deleteledgermetadata.js";
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2DeleteLedgerMetadataServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.V2DeleteLedgerMetadataResponse$inboundSchema),
