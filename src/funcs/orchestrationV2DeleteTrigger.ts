...
import { V2DeleteTriggerServerList } from "../sdk/models/operations/v2deletetrigger.js";
 ...
 */
export function orchestrationV2DeleteTrigger(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2DeleteTriggerServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.V2DeleteTriggerResponse$inboundSchema),
