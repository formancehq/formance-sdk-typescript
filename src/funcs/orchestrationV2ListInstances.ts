...
import { V2ListInstancesServerList } from "../sdk/models/operations/v2listinstances.js";
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2ListInstancesServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V2ListInstancesResponse$inboundSchema, {
