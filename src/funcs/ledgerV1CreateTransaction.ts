...
import { CreateTransactionServerList } from "../sdk/models/operations/createtransaction.js";
 ...
 */
export function ledgerV1CreateTransaction(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(CreateTransactionServerList[0], {
