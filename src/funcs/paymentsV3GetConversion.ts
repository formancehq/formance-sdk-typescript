...
import { V3GetConversionServerList } from "../sdk/models/operations/v3getconversion.js";
 ...
 */
export function paymentsV3GetConversion(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V3GetConversionRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3GetConversionServerList[0], { charEncoding: "percent" })();

  const pathParams = {
    conversionID: encodeSimple("conversionID", payload.conversionID, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  const path = pathToFunc("/api/payments/v3/conversions/{conversionID}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3GetConversionResponse$inboundSchema, {
      key: "V3GetConversionResponse",
    }),
