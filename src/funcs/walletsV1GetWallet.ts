...
import { GetWalletServerList } from "../sdk/models/operations/getwallet.js";
 ...
 */
export function walletsV1GetWallet(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetWalletServerList[0], { charEncoding: "percent" })();
