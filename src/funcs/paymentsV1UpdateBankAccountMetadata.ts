...
import { UpdateBankAccountMetadataServerList } from "../sdk/models/operations/updatebankaccountmetadata.js";
 ...
 */
export function paymentsV1UpdateBankAccountMetadata(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateBankAccountMetadataRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(UpdateBankAccountMetadataServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.UpdateBankAccountMetadataResponse$inboundSchema),
