...
import { V3ListOrdersServerList } from "../sdk/models/operations/v3listorders.js";
 ...
 */
export function paymentsV3ListOrders(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V3ListOrdersRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3ListOrdersServerList[0], { charEncoding: "percent" })();

  const path = pathToFunc("/api/payments/v3/orders")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3ListOrdersResponse$inboundSchema, {
      key: "V3OrdersCursorResponse",
    }),
