 ...
 * Run workflow
 */
export async function orchestrationRunWorkflow(
    client$: SDKCore,
...
> {
    ...
    const path$ = pathToFunc("/api/orchestration/workflows/{workflowID}/instances")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(201, operations.RunWorkflowResponse$inboundSchema, { key: "RunWorkflowResponse" }),
