...
import { V2CountAccountsServerList } from "../sdk/models/operations/v2countaccounts.js";
 ...
 */
export function ledgerV2CountAccounts(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2CountAccountsServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.V2CountAccountsResponse$inboundSchema, {
      hdrs: true,
    }),
