...
import { ListPaymentsServerList } from "../sdk/models/operations/listpayments.js";
 ...
 */
export function paymentsV1ListPayments(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListPaymentsServerList[0], { charEncoding: "percent" })();
