...
import { DeleteTransferInitiationServerList } from "../sdk/models/operations/deletetransferinitiation.js";
 ...
 */
export function paymentsV1DeleteTransferInitiation(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteTransferInitiationRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeleteTransferInitiationServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.DeleteTransferInitiationResponse$inboundSchema),
