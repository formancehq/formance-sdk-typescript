 ...
 */
export function webhooksV1ReplayDelivery(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ReplayDeliveryRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/webhooks/deliveries/{id}/replay")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ReplayDeliveryResponse$inboundSchema, {
      key: "DeliveryResponse",
    }),
