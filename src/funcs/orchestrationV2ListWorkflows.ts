...
import { V2ListWorkflowsServerList } from "../sdk/models/operations/v2listworkflows.js";
 ...
 */
export function orchestrationV2ListWorkflows(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2ListWorkflowsServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V2ListWorkflowsResponse$inboundSchema, {
