...
import { ListTransferInitiationsServerList } from "../sdk/models/operations/listtransferinitiations.js";
 ...
 */
export function paymentsV1ListTransferInitiations(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListTransferInitiationsServerList[0], {
