...
import { V3UpdateConnectorConfigServerList } from "../sdk/models/operations/v3updateconnectorconfig.js";
 ...
 */
export function paymentsV3V3UpdateConnectorConfig(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3UpdateConnectorConfigRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.V3ConnectorConfig, { explode: true });

  const baseURL = options?.serverURL
    || pathToFunc(V3UpdateConnectorConfigServerList[0], {
  ...
  const path = pathToFunc("/api/payments/v3/connectors/{connectorID}/config")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.V3UpdateConnectorConfigResponse$inboundSchema),
