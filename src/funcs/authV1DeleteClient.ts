...
import { DeleteClientServerList } from "../sdk/models/operations/deleteclient.js";
 ...
 */
export function authV1DeleteClient(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeleteClientServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.DeleteClientResponse$inboundSchema),
    M.fail("default"),
