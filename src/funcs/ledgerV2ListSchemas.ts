...
import { V2ListSchemasServerList } from "../sdk/models/operations/v2listschemas.js";
 ...
 */
export function ledgerV2ListSchemas(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V2ListSchemasRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2ListSchemasServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/ledger/v2/{ledger}/schemas")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V2ListSchemasResponse$inboundSchema, {
      key: "V2SchemasCursorResponse",
    }),
