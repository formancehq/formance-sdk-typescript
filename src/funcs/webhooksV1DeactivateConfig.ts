...
import { DeactivateConfigServerList } from "../sdk/models/operations/deactivateconfig.js";
 ...
 */
export function webhooksV1DeactivateConfig(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeactivateConfigServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/webhooks/configs/{id}/deactivate")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeactivateConfigResponse$inboundSchema, {
      key: "ConfigResponse",
    }),
