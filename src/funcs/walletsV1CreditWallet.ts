...
import { CreditWalletServerList } from "../sdk/models/operations/creditwallet.js";
 ...
 */
export function walletsV1CreditWallet(
  client: SDKCore,
...
> {
  ...
  const body = encodeJSON("body", payload.CreditWalletRequest, {
    explode: true,
  });

  const baseURL = options?.serverURL
    || pathToFunc(CreditWalletServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.CreditWalletResponse$inboundSchema),
