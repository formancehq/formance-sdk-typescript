...
import { V2InsertSchemaServerList } from "../sdk/models/operations/v2insertschema.js";
 ...
 */
export function ledgerV2InsertSchema(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V2InsertSchemaRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.V2SchemaData, { explode: true });

  const baseURL = options?.serverURL
    || pathToFunc(V2InsertSchemaServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.V2InsertSchemaResponse$inboundSchema, { hdrs: true }),
