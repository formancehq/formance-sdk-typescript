...
import { V3GetPoolBalancesLatestServerList } from "../sdk/models/operations/v3getpoolbalanceslatest.js";
 ...
 */
export function paymentsV3GetPoolBalancesLatest(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3GetPoolBalancesLatestRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3GetPoolBalancesLatestServerList[0], {
  ...
  const path = pathToFunc("/api/payments/v3/pools/{poolID}/balances/latest")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3GetPoolBalancesLatestResponse$inboundSchema, {
      key: "V3PoolBalancesResponse",
    }),
