...
import { V2GetAccountServerList } from "../sdk/models/operations/v2getaccount.js";
 ...
 */
export function ledgerV2GetAccount(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2GetAccountServerList[0], { charEncoding: "percent" })();
