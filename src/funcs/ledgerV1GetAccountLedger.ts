...
import { GetAccountLedgerServerList } from "../sdk/models/operations/getaccountledger.js";
 ...
 */
export function ledgerV1GetAccountLedger(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAccountLedgerRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetAccountLedgerServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/ledger/{ledger}/accounts/{address}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAccountLedgerResponse$inboundSchema, {
      key: "AccountResponse",
    }),
