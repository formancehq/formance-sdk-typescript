...
import { GetBalancesServerList } from "../sdk/models/operations/getbalances.js";
 ...
 */
export function ledgerV1GetBalances(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetBalancesServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/ledger/{ledger}/balances")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetBalancesResponse$inboundSchema, {
