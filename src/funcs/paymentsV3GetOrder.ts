...
import { V3GetOrderServerList } from "../sdk/models/operations/v3getorder.js";
 ...
 */
export function paymentsV3GetOrder(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V3GetOrderRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3GetOrderServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/payments/v3/orders/{orderID}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3GetOrderResponse$inboundSchema, {
      key: "V3GetOrderResponse",
    }),
