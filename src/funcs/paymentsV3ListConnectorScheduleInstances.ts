...
import { V3ListConnectorScheduleInstancesServerList } from "../sdk/models/operations/v3listconnectorscheduleinstances.js";
 ...
 */
export function paymentsV3ListConnectorScheduleInstances(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3ListConnectorScheduleInstancesRequest$outboundSchema.parse(
        value,
      ),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3ListConnectorScheduleInstancesServerList[0], {
  ...
  >(
    M.json(
      200,
      operations.V3ListConnectorScheduleInstancesResponse$inboundSchema,
      { key: "V3ConnectorScheduleInstancesCursorResponse" },
    ),
