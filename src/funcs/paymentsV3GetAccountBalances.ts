...
import { V3GetAccountBalancesServerList } from "../sdk/models/operations/v3getaccountbalances.js";
 ...
 */
export function paymentsV3GetAccountBalances(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3GetAccountBalancesRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3GetAccountBalancesServerList[0], {
  ...
  const path = pathToFunc("/api/payments/v3/accounts/{accountID}/balances")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3GetAccountBalancesResponse$inboundSchema, {
      key: "V3BalancesCursorResponse",
    }),
