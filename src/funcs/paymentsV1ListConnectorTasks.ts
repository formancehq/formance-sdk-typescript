...
import { ListConnectorTasksServerList } from "../sdk/models/operations/listconnectortasks.js";
 ...
 */
export function paymentsV1ListConnectorTasks(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListConnectorTasksServerList[0], {
