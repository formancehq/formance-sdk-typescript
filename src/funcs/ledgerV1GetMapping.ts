...
import { GetMappingServerList } from "../sdk/models/operations/getmapping.js";
 ...
 */
export function ledgerV1GetMapping(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetMappingServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetMappingResponse$inboundSchema, {
      key: "MappingResponse",
    }),
