...
import { V2GetExporterStateServerList } from "../sdk/models/operations/v2getexporterstate.js";
 ...
 * Get exporter state
 */
export function ledgerV2GetExporterState(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2GetExporterStateServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V2GetExporterStateResponse$inboundSchema, {
      key: "V2GetExporterStateResponse",
    }),
