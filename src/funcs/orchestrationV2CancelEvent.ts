...
import { V2CancelEventServerList } from "../sdk/models/operations/v2cancelevent.js";
 ...
 */
export function orchestrationV2CancelEvent(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2CancelEventServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/orchestration/v2/instances/{instanceID}/abort")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.V2CancelEventResponse$inboundSchema),
