...
import { GetPoolBalancesLatestServerList } from "../sdk/models/operations/getpoolbalanceslatest.js";
 ...
 */
export function paymentsV1GetPoolBalancesLatest(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetPoolBalancesLatestRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetPoolBalancesLatestServerList[0], {
  ...
  const path = pathToFunc("/api/payments/pools/{poolId}/balances/latest")(
    pathParams,
  );
