 ...
 */
export async function paymentsUdpateTransferInitiationStatus(
    client$: SDKCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.UdpateTransferInitiationStatusRequest$outboundSchema.parse(value$),
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.nil(204, operations.UdpateTransferInitiationStatusResponse$inboundSchema),
