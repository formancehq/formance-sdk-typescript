...
> {
    ...
    const path$ = pathToFunc("/api/ledger/v2/{ledger}/accounts/{address}/metadata/{key}")(
        pathParams$
    );
    ...
    const [result$] = await m$.match<
        ...
        | RequestTimeoutError
        | ConnectionError
    >(m$.nil("2XX", operations.V2DeleteAccountMetadataResponse$inboundSchema), m$.fail("default"))(
        response,
