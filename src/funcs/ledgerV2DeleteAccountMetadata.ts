...
import { V2DeleteAccountMetadataServerList } from "../sdk/models/operations/v2deleteaccountmetadata.js";
 ...
 */
export function ledgerV2DeleteAccountMetadata(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2DeleteAccountMetadataServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.V2DeleteAccountMetadataResponse$inboundSchema, {
      hdrs: true,
    }),
