...
import { DeleteWorkflowServerList } from "../sdk/models/operations/deleteworkflow.js";
 ...
 */
export function orchestrationV1DeleteWorkflow(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeleteWorkflowServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.DeleteWorkflowResponse$inboundSchema),
