...
import { V2DeleteWorkflowServerList } from "../sdk/models/operations/v2deleteworkflow.js";
 ...
 */
export function orchestrationV2DeleteWorkflow(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2DeleteWorkflowServerList[0], { charEncoding: "percent" })();
