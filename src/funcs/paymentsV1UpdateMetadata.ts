...
import { UpdateMetadataServerList } from "../sdk/models/operations/updatemetadata.js";
 ...
 */
export function paymentsV1UpdateMetadata(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(UpdateMetadataServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/payments/payments/{paymentId}/metadata")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.UpdateMetadataResponse$inboundSchema),
