...
import { GetPolicyServerList } from "../sdk/models/operations/getpolicy.js";
 ...
 */
export function reconciliationV1GetPolicy(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetPolicyServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetPolicyResponse$inboundSchema, {
      key: "PolicyResponse",
    }),
