...
import { UpdateMappingServerList } from "../sdk/models/operations/updatemapping.js";
 ...
 */
export function ledgerV1UpdateMapping(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(UpdateMappingServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/ledger/{ledger}/mapping")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateMappingResponse$inboundSchema, {
      key: "MappingResponse",
    }),
