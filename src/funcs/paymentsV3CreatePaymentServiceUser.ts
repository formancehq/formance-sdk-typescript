...
import { V3CreatePaymentServiceUserServerList } from "../sdk/models/operations/v3createpaymentserviceuser.js";
 ...
 */
export function paymentsV3CreatePaymentServiceUser(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      payments.V3CreatePaymentServiceUserRequest$outboundSchema.optional()
        .parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3CreatePaymentServiceUserServerList[0], {
      charEncoding: "percent",
    })();

  const path = pathToFunc("/api/payments/v3/payment-service-users")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.V3CreatePaymentServiceUserResponse$inboundSchema, {
      key: "V3CreatePaymentServiceUserResponse",
    }),
