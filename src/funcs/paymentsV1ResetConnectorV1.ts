...
import { ResetConnectorV1ServerList } from "../sdk/models/operations/resetconnectorv1.js";
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ResetConnectorV1ServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.ResetConnectorV1Response$inboundSchema),
