...
import { V2ExportLogsServerList } from "../sdk/models/operations/v2exportlogs.js";
 ...
 */
export function ledgerV2ExportLogs(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2ExportLogsServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(200, operations.V2ExportLogsResponse$inboundSchema),
    M.fail("default"),
