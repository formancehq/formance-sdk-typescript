...
import { V2ListLedgersServerList } from "../sdk/models/operations/v2listledgers.js";
 ...
 */
export function ledgerV2ListLedgers(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2ListLedgersServerList[0], { charEncoding: "percent" })();
