...
import { V2GetLedgerInfoServerList } from "../sdk/models/operations/v2getledgerinfo.js";
 ...
 */
export function ledgerV2GetLedgerInfo(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2GetLedgerInfoServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V2GetLedgerInfoResponse$inboundSchema, {
