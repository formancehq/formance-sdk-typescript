...
import { V3RejectPaymentInitiationServerList } from "../sdk/models/operations/v3rejectpaymentinitiation.js";
 ...
 */
export function paymentsV3RejectPaymentInitiation(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3RejectPaymentInitiationRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3RejectPaymentInitiationServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.V3RejectPaymentInitiationResponse$inboundSchema),
