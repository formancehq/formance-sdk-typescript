 ...
 */
export function webhooksV1GetDeliveries(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetDeliveriesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/webhooks/deliveries")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetDeliveriesResponse$inboundSchema, {
      key: "DeliveriesResponse",
    }),
