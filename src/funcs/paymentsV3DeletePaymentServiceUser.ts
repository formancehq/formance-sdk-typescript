...
import { V3DeletePaymentServiceUserServerList } from "../sdk/models/operations/v3deletepaymentserviceuser.js";
 ...
 */
export function paymentsV3DeletePaymentServiceUser(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3DeletePaymentServiceUserRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3DeletePaymentServiceUserServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.V3DeletePaymentServiceUserResponse$inboundSchema, {
      key: "V3PaymentServiceUserDeleteResponse",
    }),
