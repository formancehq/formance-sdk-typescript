...
import { ResetConnectorServerList } from "../sdk/models/operations/resetconnector.js";
 ...
 */
export function paymentsV1ResetConnector(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ResetConnectorServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/payments/connectors/{connector}/reset")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.ResetConnectorResponse$inboundSchema),
