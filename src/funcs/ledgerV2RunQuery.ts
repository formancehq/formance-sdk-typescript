 ...
 */
export function ledgerV2RunQuery(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V2RunQueryRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/ledger/v2/{ledger}/queries/{id}/run")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V2RunQueryResponse$inboundSchema, { key: "oneOf" }),
