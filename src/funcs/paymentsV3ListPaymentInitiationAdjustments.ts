...
import { V3ListPaymentInitiationAdjustmentsServerList } from "../sdk/models/operations/v3listpaymentinitiationadjustments.js";
 ...
 */
export function paymentsV3ListPaymentInitiationAdjustments(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3ListPaymentInitiationAdjustmentsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3ListPaymentInitiationAdjustmentsServerList[0], {
  ...
  >(
    M.json(
      ...
      { key: "V3PaymentInitiationAdjustmentsCursorResponse" },
    ),
