...
import { V3ListPaymentInitiationsServerList } from "../sdk/models/operations/v3listpaymentinitiations.js";
 ...
 */
export function paymentsV3ListPaymentInitiations(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3ListPaymentInitiationsRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3ListPaymentInitiationsServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3ListPaymentInitiationsResponse$inboundSchema, {
      key: "V3PaymentInitiationsCursorResponse",
    }),
