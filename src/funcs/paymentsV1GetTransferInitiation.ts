...
import { GetTransferInitiationServerList } from "../sdk/models/operations/gettransferinitiation.js";
 ...
 */
export function paymentsV1GetTransferInitiation(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetTransferInitiationServerList[0], {
