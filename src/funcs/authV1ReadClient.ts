...
import { ReadClientServerList } from "../sdk/models/operations/readclient.js";
 ...
 */
export function authV1ReadClient(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ReadClientServerList[0], { charEncoding: "percent" })();
