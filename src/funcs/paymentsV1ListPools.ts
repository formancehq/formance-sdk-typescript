...
import { ListPoolsServerList } from "../sdk/models/operations/listpools.js";
 ...
 */
export function paymentsV1ListPools(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListPoolsServerList[0], { charEncoding: "percent" })();
