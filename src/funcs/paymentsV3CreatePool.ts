...
import { V3CreatePoolServerList } from "../sdk/models/operations/v3createpool.js";
 ...
 */
export function paymentsV3CreatePool(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      payments.V3CreatePoolRequest$outboundSchema.optional().parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3CreatePoolServerList[0], { charEncoding: "percent" })();

  const path = pathToFunc("/api/payments/v3/pools")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.V3CreatePoolResponse$inboundSchema, {
      key: "V3CreatePoolResponse",
    }),
