...
import { RevertTransactionServerList } from "../sdk/models/operations/reverttransaction.js";
 ...
 */
export function ledgerV1RevertTransaction(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(RevertTransactionServerList[0], {
