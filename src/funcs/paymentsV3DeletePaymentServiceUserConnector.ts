...
import { V3DeletePaymentServiceUserConnectorServerList } from "../sdk/models/operations/v3deletepaymentserviceuserconnector.js";
 ...
 */
export function paymentsV3DeletePaymentServiceUserConnector(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3DeletePaymentServiceUserConnectorRequest$outboundSchema
        .parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3DeletePaymentServiceUserConnectorServerList[0], {
  ...
  >(
    M.json(
      ...
      { key: "V3PaymentServiceUserDeleteConnectorResponse" },
    ),
