...
> {
    ...
    const path$ = pathToFunc("/api/payments/connectors/{connector}/tasks")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.ListConnectorTasksResponse$inboundSchema, { key: "TasksCursor" }),
