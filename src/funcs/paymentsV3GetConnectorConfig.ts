...
import { V3GetConnectorConfigServerList } from "../sdk/models/operations/v3getconnectorconfig.js";
 ...
 */
export function paymentsV3GetConnectorConfig(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3GetConnectorConfigRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3GetConnectorConfigServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3GetConnectorConfigResponse$inboundSchema, {
      key: "V3GetConnectorConfigResponse",
    }),
