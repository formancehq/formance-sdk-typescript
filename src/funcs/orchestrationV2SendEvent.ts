...
import { V2SendEventServerList } from "../sdk/models/operations/v2sendevent.js";
 ...
 */
export function orchestrationV2SendEvent(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2SendEventServerList[0], { charEncoding: "percent" })();
