...
import { ConfirmHoldServerList } from "../sdk/models/operations/confirmhold.js";
 ...
 */
export function walletsV1ConfirmHold(
  client: SDKCore,
...
> {
  ...
  const body = encodeJSON("body", payload.ConfirmHoldRequest, {
    explode: true,
  });

  const baseURL = options?.serverURL
    || pathToFunc(ConfirmHoldServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/wallets/holds/{hold_id}/confirm")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.ConfirmHoldResponse$inboundSchema),
