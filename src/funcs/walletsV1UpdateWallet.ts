...
import { UpdateWalletServerList } from "../sdk/models/operations/updatewallet.js";
 ...
 */
export function walletsV1UpdateWallet(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(UpdateWalletServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.UpdateWalletResponse$inboundSchema),
