 ...
 */
export function paymentsV3GetConnectorCapabilities(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3GetConnectorCapabilitiesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3GetConnectorCapabilitiesResponse$inboundSchema, {
      key: "V3ConnectorCapabilityResponse",
    }),
