 ...
 */
export async function paymentsV3GetInfo(
  client: SDKCore,
  ...
  >
> {
  const path = pathToFunc("/api/payments/v3/_info")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.V3GetInfoResponse$inboundSchema, {
      key: "V3ConfigInfoResponse",
    }),
