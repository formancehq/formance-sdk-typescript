 ...
 */
export function webhooksV1GetDeliveryAttempts(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetDeliveryAttemptsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/webhooks/deliveries/{id}/attempts")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetDeliveryAttemptsResponse$inboundSchema, {
      key: "DeliveryAttemptsResponse",
    }),
