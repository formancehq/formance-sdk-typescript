 ...
 */
export function paymentsV3ListPaymentServiceUserConnections(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3ListPaymentServiceUserConnectionsRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.V3ListPaymentServiceUserConnectionsResponse$inboundSchema,
