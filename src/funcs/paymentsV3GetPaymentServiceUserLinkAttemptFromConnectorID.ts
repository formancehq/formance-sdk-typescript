...
import { V3GetPaymentServiceUserLinkAttemptFromConnectorIDServerList } from "../sdk/models/operations/v3getpaymentserviceuserlinkattemptfromconnectorid.js";
 ...
 */
export function paymentsV3GetPaymentServiceUserLinkAttemptFromConnectorID(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(
      V3GetPaymentServiceUserLinkAttemptFromConnectorIDServerList[0],
  ...
  >(
    M.json(
      ...
      { key: "V3PaymentServiceUserLinkAttempt" },
    ),
