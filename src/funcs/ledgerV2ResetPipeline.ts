...
import { V2ResetPipelineServerList } from "../sdk/models/operations/v2resetpipeline.js";
 ...
 * Reset pipeline
 */
export function ledgerV2ResetPipeline(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2ResetPipelineServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(202, operations.V2ResetPipelineResponse$inboundSchema),
