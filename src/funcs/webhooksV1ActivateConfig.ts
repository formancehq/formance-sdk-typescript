...
import { ActivateConfigServerList } from "../sdk/models/operations/activateconfig.js";
 ...
 */
export function webhooksV1ActivateConfig(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ActivateConfigServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/webhooks/configs/{id}/activate")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ActivateConfigResponse$inboundSchema, {
      key: "ConfigResponse",
    }),
