...
import { V3ListPaymentServiceUsersServerList } from "../sdk/models/operations/v3listpaymentserviceusers.js";
 ...
 */
export function paymentsV3ListPaymentServiceUsers(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3ListPaymentServiceUsersRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3ListPaymentServiceUsersServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3ListPaymentServiceUsersResponse$inboundSchema, {
      key: "V3PaymentServiceUsersCursorResponse",
    }),
