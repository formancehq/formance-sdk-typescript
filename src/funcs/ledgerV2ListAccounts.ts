...
import { V2ListAccountsServerList } from "../sdk/models/operations/v2listaccounts.js";
 ...
 */
export function ledgerV2ListAccounts(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2ListAccountsServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V2ListAccountsResponse$inboundSchema, {
