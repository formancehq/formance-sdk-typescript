...
import { V3GetPoolBalancesServerList } from "../sdk/models/operations/v3getpoolbalances.js";
 ...
 */
export function paymentsV3GetPoolBalances(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3GetPoolBalancesServerList[0], {
  ...
  const path = pathToFunc("/api/payments/v3/pools/{poolID}/balances")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3GetPoolBalancesResponse$inboundSchema, {
