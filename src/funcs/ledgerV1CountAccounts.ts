...
import { CountAccountsServerList } from "../sdk/models/operations/countaccounts.js";
 ...
 */
export function ledgerV1CountAccounts(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(CountAccountsServerList[0], { charEncoding: "percent" })();
