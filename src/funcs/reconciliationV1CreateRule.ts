 ...
 */
export function reconciliationV1CreateRule(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => reconciliation.RuleRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateRuleResponse$inboundSchema, {
      key: "RuleResponse",
    }),
