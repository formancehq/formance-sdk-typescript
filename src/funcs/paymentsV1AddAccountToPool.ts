...
import { AddAccountToPoolServerList } from "../sdk/models/operations/addaccounttopool.js";
 ...
 */
export function paymentsV1AddAccountToPool(
  client: SDKCore,
...
> {
  ...
  const body = encodeJSON("body", payload.AddAccountToPoolRequest, {
    explode: true,
  });

  const baseURL = options?.serverURL
    || pathToFunc(AddAccountToPoolServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.AddAccountToPoolResponse$inboundSchema),
