...
import { V3ListPoolsServerList } from "../sdk/models/operations/v3listpools.js";
 ...
 */
export function paymentsV3ListPools(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3ListPoolsServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3ListPoolsResponse$inboundSchema, {
      key: "V3PoolsCursorResponse",
    }),
