...
import { V3GetPaymentServiceUserServerList } from "../sdk/models/operations/v3getpaymentserviceuser.js";
 ...
 */
export function paymentsV3GetPaymentServiceUser(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3GetPaymentServiceUserRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3GetPaymentServiceUserServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3GetPaymentServiceUserResponse$inboundSchema, {
      key: "V3GetPaymentServiceUserResponse",
    }),
