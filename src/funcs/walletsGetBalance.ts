 ...
 */
export async function walletsGetBalance(
    client$: SDKCore,
...
> {
    ...
    const path$ = pathToFunc("/api/wallets/wallets/{id}/balances/{balanceName}")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.GetBalanceResponse$inboundSchema, { key: "GetBalanceResponse" }),
