...
import { V2StartPipelineServerList } from "../sdk/models/operations/v2startpipeline.js";
 ...
 * Start pipeline
 */
export function ledgerV2StartPipeline(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2StartPipelineServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(202, operations.V2StartPipelineResponse$inboundSchema),
