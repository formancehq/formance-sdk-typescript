...
import { VoidHoldServerList } from "../sdk/models/operations/voidhold.js";
 ...
 */
export function walletsV1VoidHold(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(VoidHoldServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/wallets/holds/{hold_id}/void")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.VoidHoldResponse$inboundSchema),
