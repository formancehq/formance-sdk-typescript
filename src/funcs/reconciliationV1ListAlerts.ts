 ...
 */
export function reconciliationV1ListAlerts(
  client: SDKCore,
...
> {
  ...
  const path = pathToFunc("/api/reconciliation/alerts")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListAlertsResponse$inboundSchema, {
      key: "AlertsCursorResponse",
    }),
