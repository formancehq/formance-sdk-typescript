...
import { CreateWalletServerList } from "../sdk/models/operations/createwallet.js";
 ...
 */
export function walletsV1CreateWallet(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(CreateWalletServerList[0], { charEncoding: "percent" })();
