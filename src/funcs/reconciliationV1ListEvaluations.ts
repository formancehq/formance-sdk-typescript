 ...
 */
export function reconciliationV1ListEvaluations(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListEvaluationsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/reconciliation/evaluations")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListEvaluationsResponse$inboundSchema, {
      key: "EvaluationsCursorResponse",
    }),
