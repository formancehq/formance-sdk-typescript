...
import { V3GetTaskServerList } from "../sdk/models/operations/v3gettask.js";
 ...
 */
export function paymentsV3GetTask(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3GetTaskServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/payments/v3/tasks/{taskID}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3GetTaskResponse$inboundSchema, {
      key: "V3GetTaskResponse",
    }),
