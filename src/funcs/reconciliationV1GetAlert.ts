 ...
 */
export function reconciliationV1GetAlert(
  client: SDKCore,
...
> {
  ...
  const path = pathToFunc("/api/reconciliation/alerts/{alertID}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAlertResponse$inboundSchema, {
      key: "AlertResponse",
    }),
