...
import { GetServerInfoOrchestrationServerList } from "../sdk/models/operations/getserverinfoorchestration.js";
 ...
 */
export function orchestrationV1GetServerInfoOrchestration(
  client: SDKCore,
...
> {
  const baseURL = options?.serverURL
    || pathToFunc(GetServerInfoOrchestrationServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetServerInfoOrchestrationResponse$inboundSchema, {
      key: "ServerInfo",
    }),
