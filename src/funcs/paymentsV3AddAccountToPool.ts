...
import { V3AddAccountToPoolServerList } from "../sdk/models/operations/v3addaccounttopool.js";
 ...
 */
export function paymentsV3AddAccountToPool(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3AddAccountToPoolServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.V3AddAccountToPoolResponse$inboundSchema),
