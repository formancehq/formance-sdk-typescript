...
import { V2AddMetadataToAccountServerList } from "../sdk/models/operations/v2addmetadatatoaccount.js";
 ...
 */
export function ledgerV2AddMetadataToAccount(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V2AddMetadataToAccountRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2AddMetadataToAccountServerList[0], {
