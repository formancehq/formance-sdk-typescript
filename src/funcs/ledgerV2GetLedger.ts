...
import { V2GetLedgerServerList } from "../sdk/models/operations/v2getledger.js";
 ...
 */
export function ledgerV2GetLedger(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2GetLedgerServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V2GetLedgerResponse$inboundSchema, {
      key: "V2GetLedgerResponse",
    }),
