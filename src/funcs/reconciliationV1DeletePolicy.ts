...
import { DeletePolicyServerList } from "../sdk/models/operations/deletepolicy.js";
 ...
 */
export function reconciliationV1DeletePolicy(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeletePolicyServerList[0], { charEncoding: "percent" })();
