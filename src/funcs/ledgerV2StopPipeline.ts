...
import { V2StopPipelineServerList } from "../sdk/models/operations/v2stoppipeline.js";
 ...
 * Stop pipeline
 */
export function ledgerV2StopPipeline(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2StopPipelineServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(202, operations.V2StopPipelineResponse$inboundSchema),
