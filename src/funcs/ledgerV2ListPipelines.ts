...
import { V2ListPipelinesServerList } from "../sdk/models/operations/v2listpipelines.js";
 ...
 * List pipelines
 */
export function ledgerV2ListPipelines(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2ListPipelinesServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V2ListPipelinesResponse$inboundSchema, {
      key: "V2PipelinesCursorResponse",
    }),
