...
import { RunWorkflowServerList } from "../sdk/models/operations/runworkflow.js";
 ...
 */
export function orchestrationV1RunWorkflow(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(RunWorkflowServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.RunWorkflowResponse$inboundSchema, {
      key: "RunWorkflowResponse",
    }),
