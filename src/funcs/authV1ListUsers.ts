...
import { ListUsersServerList } from "../sdk/models/operations/listusers.js";
 ...
 */
export function authV1ListUsers(
  client: SDKCore,
...
> {
  const baseURL = options?.serverURL
    || pathToFunc(ListUsersServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListUsersResponse$inboundSchema, {
