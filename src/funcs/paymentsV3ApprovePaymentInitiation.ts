...
import { V3ApprovePaymentInitiationServerList } from "../sdk/models/operations/v3approvepaymentinitiation.js";
 ...
 */
export function paymentsV3ApprovePaymentInitiation(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3ApprovePaymentInitiationRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3ApprovePaymentInitiationServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.V3ApprovePaymentInitiationResponse$inboundSchema, {
      key: "V3ApprovePaymentInitiationResponse",
    }),
