...
import { V2CreateTransactionServerList } from "../sdk/models/operations/v2createtransaction.js";
 ...
 */
export function ledgerV2CreateTransaction(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V2CreateTransactionRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2CreateTransactionServerList[0], {
