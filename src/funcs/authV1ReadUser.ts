...
import { ReadUserServerList } from "../sdk/models/operations/readuser.js";
 ...
 */
export function authV1ReadUser(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ReadUserServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ReadUserResponse$inboundSchema, {
      key: "ReadUserResponse",
    }),
    M.fail("default"),
