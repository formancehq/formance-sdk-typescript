...
import { V3GetPoolServerList } from "../sdk/models/operations/v3getpool.js";
 ...
 */
export function paymentsV3GetPool(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3GetPoolServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/payments/v3/pools/{poolID}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3GetPoolResponse$inboundSchema, {
      key: "V3GetPoolResponse",
    }),
