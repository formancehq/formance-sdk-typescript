...
import { V2ListTransactionsServerList } from "../sdk/models/operations/v2listtransactions.js";
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2ListTransactionsServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V2ListTransactionsResponse$inboundSchema, {
