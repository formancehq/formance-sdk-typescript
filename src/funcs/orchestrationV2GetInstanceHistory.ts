...
import { V2GetInstanceHistoryServerList } from "../sdk/models/operations/v2getinstancehistory.js";
 ...
 */
export function orchestrationV2GetInstanceHistory(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2GetInstanceHistoryServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V2GetInstanceHistoryResponse$inboundSchema, {
