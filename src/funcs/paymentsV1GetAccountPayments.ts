...
import { GetAccountPaymentsServerList } from "../sdk/models/operations/getaccountpayments.js";
 ...
 */
export function paymentsV1GetAccountPayments(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAccountPaymentsRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetAccountPaymentsServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAccountPaymentsResponse$inboundSchema, {
      key: "AccountResponse",
    }),
