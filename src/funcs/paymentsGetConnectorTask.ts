 ...
 */
export async function paymentsGetConnectorTask(
    client$: SDKCore,
...
> {
    ...
    const path$ = pathToFunc("/api/payments/connectors/{connector}/tasks/{taskId}")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.GetConnectorTaskResponse$inboundSchema, { key: "TaskResponse" }),
