...
import { V3DeletePaymentInitiationServerList } from "../sdk/models/operations/v3deletepaymentinitiation.js";
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3DeletePaymentInitiationRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3DeletePaymentInitiationServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.V3DeletePaymentInitiationResponse$inboundSchema),
