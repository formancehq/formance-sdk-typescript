...
import { V3AddBankAccountToPaymentServiceUserServerList } from "../sdk/models/operations/v3addbankaccounttopaymentserviceuser.js";
 ...
 */
export function paymentsV3AddBankAccountToPaymentServiceUser(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3AddBankAccountToPaymentServiceUserRequest$outboundSchema
        .parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3AddBankAccountToPaymentServiceUserServerList[0], {
  ...
  >(
    M.nil(
      204,
      operations.V3AddBankAccountToPaymentServiceUserResponse$inboundSchema,
    ),
