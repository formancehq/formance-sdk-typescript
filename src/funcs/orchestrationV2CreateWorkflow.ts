...
import { V2CreateWorkflowServerList } from "../sdk/models/operations/v2createworkflow.js";
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      orchestration.V2WorkflowConfig$outboundSchema.optional().parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2CreateWorkflowServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.V2CreateWorkflowResponse$inboundSchema, {
