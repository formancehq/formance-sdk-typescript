...
import { V2UpdateLedgerMetadataServerList } from "../sdk/models/operations/v2updateledgermetadata.js";
 ...
 */
export function ledgerV2UpdateLedgerMetadata(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2UpdateLedgerMetadataServerList[0], {
  ...
  const doResult = await client._do(req, {
    ...
    isErrorStatusCode: (statusCode: number) =>
      !matchStatusCode({ status: statusCode } as Response, ["204", "5XX"]),
