...
import { V2CreateLedgerServerList } from "../sdk/models/operations/v2createledger.js";
 ...
 */
export function ledgerV2CreateLedger(
  client: SDKCore,
...
> {
  ...
  const body = encodeJSON("body", payload.V2CreateLedgerRequest, {
    explode: true,
  });

  const baseURL = options?.serverURL
    || pathToFunc(V2CreateLedgerServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.V2CreateLedgerResponse$inboundSchema),
