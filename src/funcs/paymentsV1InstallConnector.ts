...
import { InstallConnectorServerList } from "../sdk/models/operations/installconnector.js";
 ...
 */
export function paymentsV1InstallConnector(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(InstallConnectorServerList[0], { charEncoding: "percent" })();
