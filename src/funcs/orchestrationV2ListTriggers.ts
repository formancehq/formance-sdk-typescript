...
import { V2ListTriggersServerList } from "../sdk/models/operations/v2listtriggers.js";
 ...
 */
export function orchestrationV2ListTriggers(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2ListTriggersServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V2ListTriggersResponse$inboundSchema, {
