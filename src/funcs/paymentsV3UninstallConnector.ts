...
import { V3UninstallConnectorServerList } from "../sdk/models/operations/v3uninstallconnector.js";
 ...
 */
export function paymentsV3UninstallConnector(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3UninstallConnectorRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3UninstallConnectorServerList[0], {
  ...
  const path = pathToFunc("/api/payments/v3/connectors/{connectorID}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.V3UninstallConnectorResponse$inboundSchema, {
      key: "V3UninstallConnectorResponse",
    }),
