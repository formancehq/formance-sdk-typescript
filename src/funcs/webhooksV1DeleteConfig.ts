...
import { DeleteConfigServerList } from "../sdk/models/operations/deleteconfig.js";
 ...
 */
export function webhooksV1DeleteConfig(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeleteConfigServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/webhooks/configs/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(200, operations.DeleteConfigResponse$inboundSchema),
