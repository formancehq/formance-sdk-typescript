...
import { V3GetAccountServerList } from "../sdk/models/operations/v3getaccount.js";
 ...
 */
export function paymentsV3GetAccount(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3GetAccountServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/payments/v3/accounts/{accountID}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3GetAccountResponse$inboundSchema, {
      key: "V3GetAccountResponse",
    }),
