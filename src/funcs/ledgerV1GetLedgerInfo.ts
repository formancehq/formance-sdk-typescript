...
import { GetLedgerInfoServerList } from "../sdk/models/operations/getledgerinfo.js";
 ...
 */
export function ledgerV1GetLedgerInfo(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetLedgerInfoServerList[0], { charEncoding: "percent" })();
