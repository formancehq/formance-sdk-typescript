...
import { V3GetPaymentServerList } from "../sdk/models/operations/v3getpayment.js";
 ...
 */
export function paymentsV3GetPayment(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3GetPaymentServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/payments/v3/payments/{paymentID}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3GetPaymentResponse$inboundSchema, {
      key: "V3GetPaymentResponse",
    }),
