 ...
 */
export function reconciliationV1ListAlertEvents(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListAlertEventsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/reconciliation/alerts/{alertID}/events")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListAlertEventsResponse$inboundSchema, {
      key: "AlertEventsCursorResponse",
    }),
