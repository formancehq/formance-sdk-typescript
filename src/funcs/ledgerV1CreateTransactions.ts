...
import { CreateTransactionsServerList } from "../sdk/models/operations/createtransactions.js";
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(CreateTransactionsServerList[0], {
  ...
  const path = pathToFunc("/api/ledger/{ledger}/transactions/batch")(
    pathParams,
  );
