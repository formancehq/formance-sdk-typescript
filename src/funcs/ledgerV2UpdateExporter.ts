...
import { V2UpdateExporterServerList } from "../sdk/models/operations/v2updateexporter.js";
 ...
 */
export function ledgerV2UpdateExporter(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V2UpdateExporterRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.V2ExporterConfiguration, {
    explode: true,
  });

  const baseURL = options?.serverURL
    || pathToFunc(V2UpdateExporterServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.V2UpdateExporterResponse$inboundSchema),
