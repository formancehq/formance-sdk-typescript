...
import { V2DeleteBucketServerList } from "../sdk/models/operations/v2deletebucket.js";
 ...
 */
export function ledgerV2DeleteBucket(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V2DeleteBucketRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2DeleteBucketServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/ledger/v2/_/buckets/{bucket}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.V2DeleteBucketResponse$inboundSchema),
    M.json(404, operations.V2DeleteBucketResponse$inboundSchema, {
      key: "V2ErrorResponse",
    }),
