...
import { V2GetInstanceStageHistoryServerList } from "../sdk/models/operations/v2getinstancestagehistory.js";
 ...
 */
export function orchestrationV2GetInstanceStageHistory(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V2GetInstanceStageHistoryRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2GetInstanceStageHistoryServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V2GetInstanceStageHistoryResponse$inboundSchema, {
