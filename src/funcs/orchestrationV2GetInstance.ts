...
import { V2GetInstanceServerList } from "../sdk/models/operations/v2getinstance.js";
 ...
 */
export function orchestrationV2GetInstance(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2GetInstanceServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/orchestration/v2/instances/{instanceID}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V2GetInstanceResponse$inboundSchema, {
