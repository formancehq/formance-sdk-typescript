...
import { V3UpdatePoolQueryServerList } from "../sdk/models/operations/v3updatepoolquery.js";
 ...
 */
export function paymentsV3UpdatePoolQuery(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.V3UpdatePoolQueryRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.V3UpdatePoolQueryRequest, {
    explode: true,
  });

  const baseURL = options?.serverURL
    || pathToFunc(V3UpdatePoolQueryServerList[0], {
  ...
  const path = pathToFunc("/api/payments/v3/pools/{poolID}/query")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.V3UpdatePoolQueryResponse$inboundSchema),
