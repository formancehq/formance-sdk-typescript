...
import { V3ForwardPaymentServiceUserBankAccountServerList } from "../sdk/models/operations/v3forwardpaymentserviceuserbankaccount.js";
 ...
 */
export function paymentsV3ForwardPaymentServiceUserBankAccount(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3ForwardPaymentServiceUserBankAccountRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.V3ForwardPaymentServiceUserBankAccountRequest,
    { explode: true },
  );

  const baseURL = options?.serverURL
    || pathToFunc(V3ForwardPaymentServiceUserBankAccountServerList[0], {
  ...
  >(
    M.json(
      ...
      { key: "V3ForwardPaymentServiceUserBankAccountResponse" },
    ),
