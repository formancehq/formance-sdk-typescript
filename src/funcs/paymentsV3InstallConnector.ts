...
import { V3InstallConnectorServerList } from "../sdk/models/operations/v3installconnector.js";
 ...
 */
export function paymentsV3InstallConnector(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3InstallConnectorServerList[0], {
  ...
  const path = pathToFunc("/api/payments/v3/connectors/install/{connector}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.V3InstallConnectorResponse$inboundSchema, {
      key: "V3InstallConnectorResponse",
    }),
