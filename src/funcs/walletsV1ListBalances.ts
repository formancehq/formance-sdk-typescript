...
import { ListBalancesServerList } from "../sdk/models/operations/listbalances.js";
 ...
 */
export function walletsV1ListBalances(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListBalancesServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListBalancesResponse$inboundSchema, {
