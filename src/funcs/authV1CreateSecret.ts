...
import { CreateSecretServerList } from "../sdk/models/operations/createsecret.js";
...
> {
  ...
  const body = encodeJSON("body", payload.SecretOptions, { explode: true });

  const baseURL = options?.serverURL
    || pathToFunc(CreateSecretServerList[0], { charEncoding: "percent" })();
