...
import { V3CreateLinkForPaymentServiceUserServerList } from "../sdk/models/operations/v3createlinkforpaymentserviceuser.js";
 ...
 */
export function paymentsV3CreateLinkForPaymentServiceUser(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3CreateLinkForPaymentServiceUserRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload.V3PaymentServiceUserCreateLinkRequest,
    { explode: true },
  );

  const baseURL = options?.serverURL
    || pathToFunc(V3CreateLinkForPaymentServiceUserServerList[0], {
  ...
  >(
    M.json(
      201,
      operations.V3CreateLinkForPaymentServiceUserResponse$inboundSchema,
      { key: "V3PaymentServiceUserCreateLinkResponse" },
    ),
