 ...
 */
export function reconciliationV1ListRules(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListRulesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/reconciliation/rules")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListRulesResponse$inboundSchema, {
      key: "RulesCursorResponse",
    }),
