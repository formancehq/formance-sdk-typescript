...
import { V2ListLogsServerList } from "../sdk/models/operations/v2listlogs.js";
 ...
 */
export function ledgerV2ListLogs(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2ListLogsServerList[0], { charEncoding: "percent" })();
