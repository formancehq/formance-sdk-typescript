...
import { V3ListConnectorsServerList } from "../sdk/models/operations/v3listconnectors.js";
 ...
 */
export function paymentsV3ListConnectors(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3ListConnectorsServerList[0], { charEncoding: "percent" })();

  const path = pathToFunc("/api/payments/v3/connectors")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3ListConnectorsResponse$inboundSchema, {
      key: "V3ConnectorsCursorResponse",
    }),
