...
import { GetWalletSummaryServerList } from "../sdk/models/operations/getwalletsummary.js";
 ...
 */
export function walletsV1GetWalletSummary(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetWalletSummaryServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetWalletSummaryResponse$inboundSchema, {
      key: "GetWalletSummaryResponse",
    }),
    M.nil(404, operations.GetWalletSummaryResponse$inboundSchema),
