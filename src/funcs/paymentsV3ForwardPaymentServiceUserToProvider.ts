...
import { V3ForwardPaymentServiceUserToProviderServerList } from "../sdk/models/operations/v3forwardpaymentserviceusertoprovider.js";
 ...
 */
export function paymentsV3ForwardPaymentServiceUserToProvider(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3ForwardPaymentServiceUserToProviderRequest$outboundSchema
        .parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3ForwardPaymentServiceUserToProviderServerList[0], {
  ...
  >(
    M.nil(
      204,
      operations.V3ForwardPaymentServiceUserToProviderResponse$inboundSchema,
    ),
