 ...
 */
export async function ledgerGetAccount(
    client$: SDKCore,
...
> {
    ...
    const path$ = pathToFunc("/api/ledger/{ledger}/accounts/{address}")(pathParams$);
    ...
    const [result$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.GetAccountResponse$inboundSchema, { key: "AccountResponse" }),
