...
import { V3ListPaymentsServerList } from "../sdk/models/operations/v3listpayments.js";
 ...
 */
export function paymentsV3ListPayments(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3ListPaymentsServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3ListPaymentsResponse$inboundSchema, {
      key: "V3PaymentsCursorResponse",
    }),
