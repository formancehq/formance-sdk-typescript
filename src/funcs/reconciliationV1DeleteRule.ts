 ...
 */
export function reconciliationV1DeleteRule(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteRuleRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.DeleteRuleResponse$inboundSchema),
