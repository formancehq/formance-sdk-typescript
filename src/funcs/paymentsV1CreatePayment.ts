...
import { CreatePaymentServerList } from "../sdk/models/operations/createpayment.js";
 ...
 */
export function paymentsV1CreatePayment(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => payments.PaymentRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(CreatePaymentServerList[0], { charEncoding: "percent" })();
