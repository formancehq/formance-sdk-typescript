...
import { V3ResetConnectorServerList } from "../sdk/models/operations/v3resetconnector.js";
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3ResetConnectorServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.V3ResetConnectorResponse$inboundSchema, {
      key: "V3ResetConnectorResponse",
    }),
