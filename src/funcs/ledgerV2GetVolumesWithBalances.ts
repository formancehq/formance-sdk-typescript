...
import { V2GetVolumesWithBalancesServerList } from "../sdk/models/operations/v2getvolumeswithbalances.js";
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V2GetVolumesWithBalancesRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2GetVolumesWithBalancesServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V2GetVolumesWithBalancesResponse$inboundSchema, {
