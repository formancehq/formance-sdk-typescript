...
import { ReadTriggerServerList } from "../sdk/models/operations/readtrigger.js";
 ...
 */
export function orchestrationV1ReadTrigger(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ReadTriggerServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/orchestration/triggers/{triggerID}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ReadTriggerResponse$inboundSchema, {
      key: "ReadTriggerResponse",
    }),
