...
import { GetWorkflowServerList } from "../sdk/models/operations/getworkflow.js";
 ...
 */
export function orchestrationV1GetWorkflow(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetWorkflowServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/orchestration/workflows/{flowId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetWorkflowResponse$inboundSchema, {
      key: "GetWorkflowResponse",
    }),
