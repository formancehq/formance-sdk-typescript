...
import { V3UpdateLinkForPaymentServiceUserOnConnectorServerList } from "../sdk/models/operations/v3updatelinkforpaymentserviceuseronconnector.js";
 ...
 */
export function paymentsV3UpdateLinkForPaymentServiceUserOnConnector(
  client: SDKCore,
...
> {
  ...
  const body = encodeJSON(
    "body",
    payload.V3PaymentServiceUserUpdateLinkRequest,
    { explode: true },
  );

  const baseURL = options?.serverURL
    || pathToFunc(V3UpdateLinkForPaymentServiceUserOnConnectorServerList[0], {
  ...
  >(
    M.json(
      201,
      operations
        .V3UpdateLinkForPaymentServiceUserOnConnectorResponse$inboundSchema,
      { key: "V3PaymentServiceUserUpdateLinkResponse" },
    ),
