...
import { GetBalancesAggregatedServerList } from "../sdk/models/operations/getbalancesaggregated.js";
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetBalancesAggregatedRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetBalancesAggregatedServerList[0], {
  ...
  const path = pathToFunc("/api/ledger/{ledger}/aggregate/balances")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetBalancesAggregatedResponse$inboundSchema, {
