...
import { V3RemoveAccountFromPoolServerList } from "../sdk/models/operations/v3removeaccountfrompool.js";
 ...
 */
export function paymentsV3RemoveAccountFromPool(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3RemoveAccountFromPoolRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3RemoveAccountFromPoolServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.V3RemoveAccountFromPoolResponse$inboundSchema),
