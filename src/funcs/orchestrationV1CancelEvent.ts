...
import { CancelEventServerList } from "../sdk/models/operations/cancelevent.js";
 ...
 */
export function orchestrationV1CancelEvent(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(CancelEventServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/orchestration/instances/{instanceID}/abort")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.CancelEventResponse$inboundSchema),
