...
import { V2GetTransactionServerList } from "../sdk/models/operations/v2gettransaction.js";
 ...
 */
export function ledgerV2GetTransaction(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2GetTransactionServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/ledger/v2/{ledger}/transactions/{id}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V2GetTransactionResponse$inboundSchema, {
