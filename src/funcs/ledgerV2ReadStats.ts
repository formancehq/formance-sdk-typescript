...
import { V2ReadStatsServerList } from "../sdk/models/operations/v2readstats.js";
 ...
 */
export function ledgerV2ReadStats(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2ReadStatsServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V2ReadStatsResponse$inboundSchema, {
      key: "V2StatsResponse",
    }),
