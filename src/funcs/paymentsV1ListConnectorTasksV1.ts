...
import { ListConnectorTasksV1ServerList } from "../sdk/models/operations/listconnectortasksv1.js";
 ...
 */
export function paymentsV1ListConnectorTasksV1(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListConnectorTasksV1ServerList[0], {
