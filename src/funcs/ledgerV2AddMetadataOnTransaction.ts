...
import { V2AddMetadataOnTransactionServerList } from "../sdk/models/operations/v2addmetadataontransaction.js";
 ...
 */
export function ledgerV2AddMetadataOnTransaction(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2AddMetadataOnTransactionServerList[0], {
