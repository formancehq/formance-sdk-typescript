...
import { V2ListTriggersOccurrencesServerList } from "../sdk/models/operations/v2listtriggersoccurrences.js";
 ...
 */
export function orchestrationV2ListTriggersOccurrences(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2ListTriggersOccurrencesServerList[0], {
