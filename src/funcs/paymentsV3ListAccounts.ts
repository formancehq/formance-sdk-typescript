...
import { V3ListAccountsServerList } from "../sdk/models/operations/v3listaccounts.js";
 ...
 */
export function paymentsV3ListAccounts(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3ListAccountsServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3ListAccountsResponse$inboundSchema, {
      key: "V3AccountsCursorResponse",
    }),
