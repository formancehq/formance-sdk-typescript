...
import { GetConnectorTaskV1ServerList } from "../sdk/models/operations/getconnectortaskv1.js";
 ...
 */
export function paymentsV1GetConnectorTaskV1(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetConnectorTaskV1ServerList[0], {
