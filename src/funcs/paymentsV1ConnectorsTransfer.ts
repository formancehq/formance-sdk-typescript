...
import { ConnectorsTransferServerList } from "../sdk/models/operations/connectorstransfer.js";
 ...
 */
export function paymentsV1ConnectorsTransfer(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ConnectorsTransferServerList[0], {
  ...
  const path = pathToFunc("/api/payments/connectors/{connector}/transfers")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ConnectorsTransferResponse$inboundSchema, {
