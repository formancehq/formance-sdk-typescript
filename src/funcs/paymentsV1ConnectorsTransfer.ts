 ...
 */
export async function paymentsV1ConnectorsTransfer(
  client$: SDKCore,
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.ConnectorsTransferRequest$outboundSchema.parse(value$),
  ...
  const body$ = encodeJSON$("body", payload$.TransferRequest, {
    explode: true,
  });
