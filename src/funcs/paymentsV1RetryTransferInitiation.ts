...
import { RetryTransferInitiationServerList } from "../sdk/models/operations/retrytransferinitiation.js";
 ...
 */
export function paymentsV1RetryTransferInitiation(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RetryTransferInitiationRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(RetryTransferInitiationServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.RetryTransferInitiationResponse$inboundSchema),
