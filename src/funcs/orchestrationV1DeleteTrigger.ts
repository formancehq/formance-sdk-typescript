...
import { DeleteTriggerServerList } from "../sdk/models/operations/deletetrigger.js";
 ...
 */
export function orchestrationV1DeleteTrigger(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeleteTriggerServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(204, operations.DeleteTriggerResponse$inboundSchema),
