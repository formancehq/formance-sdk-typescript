...
import { V3RetryPaymentInitiationServerList } from "../sdk/models/operations/v3retrypaymentinitiation.js";
 ...
 */
export function paymentsV3RetryPaymentInitiation(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.V3RetryPaymentInitiationRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3RetryPaymentInitiationServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.V3RetryPaymentInitiationResponse$inboundSchema, {
      key: "V3RetryPaymentInitiationResponse",
    }),
