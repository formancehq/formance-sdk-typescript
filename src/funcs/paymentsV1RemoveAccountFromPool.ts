...
import { RemoveAccountFromPoolServerList } from "../sdk/models/operations/removeaccountfrompool.js";
 ...
 */
export function paymentsV1RemoveAccountFromPool(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RemoveAccountFromPoolRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(RemoveAccountFromPoolServerList[0], {
  ...
  const path = pathToFunc("/api/payments/pools/{poolId}/accounts/{accountId}")(
    pathParams,
  );
