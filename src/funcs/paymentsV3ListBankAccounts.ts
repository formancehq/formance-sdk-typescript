...
import { V3ListBankAccountsServerList } from "../sdk/models/operations/v3listbankaccounts.js";
 ...
 */
export function paymentsV3ListBankAccounts(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V3ListBankAccountsServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V3ListBankAccountsResponse$inboundSchema, {
      key: "V3BankAccountsCursorResponse",
    }),
