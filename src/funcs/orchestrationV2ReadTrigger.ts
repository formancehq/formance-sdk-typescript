...
import { V2ReadTriggerServerList } from "../sdk/models/operations/v2readtrigger.js";
 ...
 */
export function orchestrationV2ReadTrigger(
  client: SDKCore,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(V2ReadTriggerServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/api/orchestration/v2/triggers/{triggerID}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.V2ReadTriggerResponse$inboundSchema, {
