 ...
 */
export function webhooksV1GetDelivery(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetDeliveryRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/webhooks/deliveries/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetDeliveryResponse$inboundSchema, {
