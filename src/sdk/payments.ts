...
export class Payments extends ClientSDK {
    ...
    async addAccountToPool(
        ...
        const [result$] = await this.matcher<operations.AddAccountToPoolResponse>()
            .void(204, operations.AddAccountToPoolResponse$inboundSchema)
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
    ...
    async createPayment(
        ...
        const [result$] = await this.matcher<operations.CreatePaymentResponse>()
            .json(200, operations.CreatePaymentResponse$inboundSchema, { key: "PaymentResponse" })
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async createPool(
        ...
        const [result$] = await this.matcher<operations.CreatePoolResponse>()
            .json(200, operations.CreatePoolResponse$inboundSchema, { key: "PoolResponse" })
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async deletePool(
        ...
        const [result$] = await this.matcher<operations.DeletePoolResponse>()
            .void(204, operations.DeletePoolResponse$inboundSchema)
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async deleteTransferInitiation(
        ...
        const [result$] = await this.matcher<operations.DeleteTransferInitiationResponse>()
            .void(204, operations.DeleteTransferInitiationResponse$inboundSchema)
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async getConnectorTask(
        ...
        const [result$] = await this.matcher<operations.GetConnectorTaskResponse>()
            .json(200, operations.GetConnectorTaskResponse$inboundSchema, { key: "TaskResponse" })
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async getConnectorTaskV1(
        ...
        const [result$] = await this.matcher<operations.GetConnectorTaskV1Response>()
            .json(200, operations.GetConnectorTaskV1Response$inboundSchema, { key: "TaskResponse" })
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async getPayment(
        ...
        const [result$] = await this.matcher<operations.GetPaymentResponse>()
            .json(200, operations.GetPaymentResponse$inboundSchema, { key: "PaymentResponse" })
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async getPool(
        ...
        const [result$] = await this.matcher<operations.GetPoolResponse>()
            .json(200, operations.GetPoolResponse$inboundSchema, { key: "PoolResponse" })
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async listConnectorTasks(
        ...
        const [result$] = await this.matcher<operations.ListConnectorTasksResponse>()
            .json(200, operations.ListConnectorTasksResponse$inboundSchema, { key: "TasksCursor" })
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async listPayments(
        ...
        const [result$] = await this.matcher<operations.ListPaymentsResponse>()
            .json(200, operations.ListPaymentsResponse$inboundSchema, { key: "PaymentsCursor" })
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async listPools(
        ...
        const [result$] = await this.matcher<operations.ListPoolsResponse>()
            .json(200, operations.ListPoolsResponse$inboundSchema, { key: "PoolsCursor" })
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async removeAccountFromPool(
        ...
        const [result$] = await this.matcher<operations.RemoveAccountFromPoolResponse>()
            .void(204, operations.RemoveAccountFromPoolResponse$inboundSchema)
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async resetConnector(
        ...
        const [result$] = await this.matcher<operations.ResetConnectorResponse>()
            .void(204, operations.ResetConnectorResponse$inboundSchema)
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async resetConnectorV1(
        ...
        const [result$] = await this.matcher<operations.ResetConnectorV1Response>()
            .void(204, operations.ResetConnectorV1Response$inboundSchema)
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async retryTransferInitiation(
        ...
        const [result$] = await this.matcher<operations.RetryTransferInitiationResponse>()
            .void(204, operations.RetryTransferInitiationResponse$inboundSchema)
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async reverseTransferInitiation(
        ...
        const [result$] = await this.matcher<operations.ReverseTransferInitiationResponse>()
            .void(204, operations.ReverseTransferInitiationResponse$inboundSchema)
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async udpateTransferInitiationStatus(
        ...
        const [result$] = await this.matcher<operations.UdpateTransferInitiationStatusResponse>()
            .void(204, operations.UdpateTransferInitiationStatusResponse$inboundSchema)
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async uninstallConnector(
        ...
        const [result$] = await this.matcher<operations.UninstallConnectorResponse>()
            .void(204, operations.UninstallConnectorResponse$inboundSchema)
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async uninstallConnectorV1(
        ...
        const [result$] = await this.matcher<operations.UninstallConnectorV1Response>()
            .void(204, operations.UninstallConnectorV1Response$inboundSchema)
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async updateBankAccountMetadata(
        ...
        const [result$] = await this.matcher<operations.UpdateBankAccountMetadataResponse>()
            .void(204, operations.UpdateBankAccountMetadataResponse$inboundSchema)
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async updateConnectorConfigV1(
        ...
        const [result$] = await this.matcher<operations.UpdateConnectorConfigV1Response>()
            .void(204, operations.UpdateConnectorConfigV1Response$inboundSchema)
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
    ...
    async updateMetadata(
        ...
        const [result$] = await this.matcher<operations.UpdateMetadataResponse>()
            .void(204, operations.UpdateMetadataResponse$inboundSchema)
            .json("default", errors.PaymentsErrorResponse$inboundSchema, { err: true })
            .match(response, { extraFields: responseFields$ });
