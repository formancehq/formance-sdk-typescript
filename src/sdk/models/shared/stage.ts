...
import { Update, Update$inboundSchema, Update$Outbound, Update$outboundSchema } from "./update.js";
import * as z from "zod";

export type Stage = StageWaitEvent | Update | StageDelay | StageSend;

/** @internal */
export const Stage$inboundSchema: z.ZodType<Stage, z.ZodTypeDef, unknown> = z.union([
    StageWaitEvent$inboundSchema,
...
/** @internal */
export const Stage$outboundSchema: z.ZodType<Stage$Outbound, z.ZodTypeDef, Stage> = z.union([
    StageWaitEvent$outboundSchema,
