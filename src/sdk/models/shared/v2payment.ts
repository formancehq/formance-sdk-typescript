...
import { V2Connector, V2Connector$ } from "./v2connector.js";
import { V2PaymentAdjustment, V2PaymentAdjustment$ } from "./v2paymentadjustment.js";
import { V2PaymentMetadata, V2PaymentMetadata$ } from "./v2paymentmetadata.js";
import { V2PaymentStatus, V2PaymentStatus$ } from "./v2paymentstatus.js";
...
export namespace Scheme$ {
    export const inboundSchema: z.ZodNativeEnum<typeof Scheme> = z.nativeEnum(Scheme);
    export const outboundSchema: z.ZodNativeEnum<typeof Scheme> = inboundSchema;
}

/** @internal */
export namespace V2PaymentType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof V2PaymentType> = z.nativeEnum(V2PaymentType);
    export const outboundSchema: z.ZodNativeEnum<typeof V2PaymentType> = inboundSchema;
}
