...
/** @internal */
export const V2Subject$inboundSchema: z.ZodType<V2Subject, z.ZodTypeDef, unknown> = z.union([
...
/** @internal */
export const V2Subject$outboundSchema: z.ZodType<V2Subject$Outbound, z.ZodTypeDef, V2Subject> =
    z.union([
