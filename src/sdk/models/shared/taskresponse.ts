...
/** @internal */
export const TaskResponseData$inboundSchema: z.ZodType<TaskResponseData, z.ZodTypeDef, unknown> =
    z.union([
        TaskStripe$inboundSchema,
        TaskWise$inboundSchema,
        TaskCurrencyCloud$inboundSchema,
...
/** @internal */
export const TaskResponse$inboundSchema: z.ZodType<TaskResponse, z.ZodTypeDef, unknown> = z.object({
    data: z.union([
        TaskStripe$inboundSchema,
        TaskWise$inboundSchema,
        TaskCurrencyCloud$inboundSchema,
