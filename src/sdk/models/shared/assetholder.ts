...
export namespace AssetHolder$ {
    export const inboundSchema: z.ZodType<AssetHolder, z.ZodTypeDef, unknown> = z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AssetHolder> = z.object({
