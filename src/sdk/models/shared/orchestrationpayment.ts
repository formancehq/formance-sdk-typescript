...
import { OrchestrationConnector, OrchestrationConnector$ } from "./orchestrationconnector.js";
import {
...
export namespace OrchestrationPaymentScheme$ {
    export const inboundSchema: z.ZodNativeEnum<typeof OrchestrationPaymentScheme> = z.nativeEnum(
        OrchestrationPaymentScheme
    );
    export const outboundSchema: z.ZodNativeEnum<typeof OrchestrationPaymentScheme> = inboundSchema;
}

/** @internal */
export namespace OrchestrationPaymentType$ {
    export const inboundSchema: z.ZodNativeEnum<typeof OrchestrationPaymentType> =
        z.nativeEnum(OrchestrationPaymentType);
    export const outboundSchema: z.ZodNativeEnum<typeof OrchestrationPaymentType> = inboundSchema;
}
