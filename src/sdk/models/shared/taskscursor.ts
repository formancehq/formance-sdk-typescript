...
/** @internal */
export const TasksCursorData$inboundSchema: z.ZodType<TasksCursorData, z.ZodTypeDef, unknown> =
    z.union([
        TaskStripe$inboundSchema,
        TaskWise$inboundSchema,
        TaskCurrencyCloud$inboundSchema,
...
/** @internal */
export const TasksCursorCursor$inboundSchema: z.ZodType<TasksCursorCursor, z.ZodTypeDef, unknown> =
    z.object({
        data: z.array(
            z.union([
                TaskStripe$inboundSchema,
...
/** @internal */
export const TasksCursor$inboundSchema: z.ZodType<TasksCursor, z.ZodTypeDef, unknown> = z.object({
