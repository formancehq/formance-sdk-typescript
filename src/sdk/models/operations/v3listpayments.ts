...
export const V3ListPaymentsServerList = [
  "http://localhost:8080/",
] as const;
...
export type V3ListPaymentsResponse = {
   ...
   * OK
   */
  v3PaymentsCursorResponse?: payments.V3PaymentsCursorResponse | undefined;
};
...
> = z.object({
  ...
  V3PaymentsCursorResponse: payments.V3PaymentsCursorResponse$inboundSchema
    .optional(),
}).transform((v) => {
  return remap$(v, {
