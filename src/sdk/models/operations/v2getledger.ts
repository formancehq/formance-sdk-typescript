...
export const V2GetLedgerServerList = [
  "http://localhost:8080/",
] as const;
...
export type V2GetLedgerResponse = {
   ...
   * OK
   */
  v2GetLedgerResponse?: ledger.V2GetLedgerResponse | undefined;
};
...
> = z.object({
  ...
  V2GetLedgerResponse: ledger.V2GetLedgerResponse$inboundSchema.optional(),
}).transform((v) => {
  return remap$(v, {
