...
export namespace DeleteWorkflowRequest$ {
    export const inboundSchema: z.ZodType<DeleteWorkflowRequest, z.ZodTypeDef, unknown> = z.object({
        flowId: z.string(),
    });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, DeleteWorkflowRequest> =
        z.object({
            flowId: z.string(),
        });
}
