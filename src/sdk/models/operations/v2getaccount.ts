...
export const V2GetAccountServerList = [
  "http://localhost:8080/",
] as const;
...
export type V2GetAccountResponse = {
   ...
   * OK
   */
  v2AccountResponse?: ledger.V2AccountResponse | undefined;
};
...
> = z.object({
  ...
  V2AccountResponse: ledger.V2AccountResponse$inboundSchema.optional(),
}).transform((v) => {
  return remap$(v, {
