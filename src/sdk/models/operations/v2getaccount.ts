...
export namespace V2GetAccountRequest$ {
    export const inboundSchema: z.ZodType<V2GetAccountRequest, z.ZodTypeDef, unknown> = z.object({
        address: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, V2GetAccountRequest> = z.object({
        address: z.string(),
        expand: z.string().optional(),
        ledger: z.string(),
        pit: z
