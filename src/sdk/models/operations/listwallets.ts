...
export const ListWalletsServerList = [
  "http://localhost:8080/",
] as const;
...
export type ListWalletsResponse = {
   ...
   * OK
   */
  listWalletsResponse?: wallets.ListWalletsResponse | undefined;
  /**
...
> = z.object({
  ...
  ListWalletsResponse: wallets.ListWalletsResponse$inboundSchema.optional(),
