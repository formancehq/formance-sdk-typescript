...
> = z
    .object({
        ReverseTransferInitiationRequest: shared.ReverseTransferInitiationRequest$inboundSchema,
        transferId: z.string(),
    })
    .transform((v) => {
        return remap$(v, {
...
> = z
    .object({
        reverseTransferInitiationRequest: shared.ReverseTransferInitiationRequest$outboundSchema,
        transferId: z.string(),
    })
    .transform((v) => {
        return remap$(v, {
...
export namespace ReverseTransferInitiationResponse$ {
    ...
    export const outboundSchema = ReverseTransferInitiationResponse$outboundSchema;
