...
export namespace CountTransactionsRequest$ {
    export const inboundSchema: z.ZodType<CountTransactionsRequest, z.ZodTypeDef, unknown> =
        z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CountTransactionsRequest> =
        z.object({
            account: z.string().optional(),
            destination: z.string().optional(),
            endTime: z
