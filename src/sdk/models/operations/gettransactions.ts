...
export namespace GetTransactionsRequest$ {
    export const inboundSchema: z.ZodType<GetTransactionsRequest, z.ZodTypeDef, unknown> = z.object(
        {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetTransactionsRequest> =
        z.object({
            cursor: z.string().optional(),
            pageSize: z.number().int().default(15),
            walletID: z.string().optional(),
