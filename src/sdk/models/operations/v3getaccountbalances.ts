...
export const V3GetAccountBalancesServerList = [
  "http://localhost:8080/",
] as const;
...
export type V3GetAccountBalancesResponse = {
   ...
   * OK
   */
  v3BalancesCursorResponse?: payments.V3BalancesCursorResponse | undefined;
};
...
> = z.object({
  ...
  V3BalancesCursorResponse: payments.V3BalancesCursorResponse$inboundSchema
    .optional(),
}).transform((v) => {
  return remap$(v, {
