...
export namespace GetBalancesAggregatedRequest$ {
    export const inboundSchema: z.ZodType<GetBalancesAggregatedRequest, z.ZodTypeDef, unknown> =
        z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetBalancesAggregatedRequest> =
        z.object({
            address: z.string().optional(),
            ledger: z.string(),
            useInsertionDate: z.boolean().optional(),
