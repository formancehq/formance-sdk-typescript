...
export const V2ListTriggersServerList = [
  "http://localhost:8080/",
] as const;
...
export type V2ListTriggersResponse = {
   ...
   * List of triggers
   */
  v2ListTriggersResponse?: orchestration.V2ListTriggersResponse | undefined;
};
...
> = z.object({
  ...
  V2ListTriggersResponse: orchestration.V2ListTriggersResponse$inboundSchema
    .optional(),
}).transform((v) => {
  return remap$(v, {
