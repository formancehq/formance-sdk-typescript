...
export namespace V2ListWorkflowsRequest$ {
    export const inboundSchema: z.ZodType<V2ListWorkflowsRequest, z.ZodTypeDef, unknown> = z.object(
        {
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, V2ListWorkflowsRequest> =
        z.object({
            cursor: z.string().optional(),
            pageSize: z.number().int().optional(),
        });
