...
export namespace V2ReadStatsRequest$ {
    export const inboundSchema: z.ZodType<V2ReadStatsRequest, z.ZodTypeDef, unknown> = z.object({
        ledger: z.string(),
    });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, V2ReadStatsRequest> = z.object({
        ledger: z.string(),
    });
}
