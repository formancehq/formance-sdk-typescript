...
export const GetInstanceServerList = [
  "http://localhost:8080/",
] as const;
...
export type GetInstanceResponse = {
  ...
  getWorkflowInstanceResponse?:
    | orchestration.GetWorkflowInstanceResponse
    | undefined;
  /**
...
> = z.object({
  ...
  GetWorkflowInstanceResponse: orchestration
    .GetWorkflowInstanceResponse$inboundSchema.optional(),
