...
export namespace ErrorCode$ {
    export const inboundSchema: z.ZodNativeEnum<typeof ErrorCode> = z.nativeEnum(ErrorCode);
    export const outboundSchema: z.ZodNativeEnum<typeof ErrorCode> = inboundSchema;
}
